# This Makefile is for the Resque extension to perl.
#
...
#     AUTHOR => []
#     BUILD_REQUIRES => { Test::More=>q[0.42], ExtUtils::MakeMaker=>q[6.36], JSON::XS=>q[0] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[Resque]
#     NAME => q[Resque]
#     NO_META => q[1]
#     PREREQ_PM => { DateTime=>q[0], Redis=>q[1.904], Devel::StackTrace=>q[0], ExtUtils::MakeMaker=>q[6.36], JSON::XS=>q[0], Time::HiRes=>q[0], Class::Accessor::Fast=>q[0], Test::More=>q[0.42], JSON=>q[0], Sys::Hostname=>q[0] }
#     VERSION => q[0.03]
#     VERSION_FROM => q[lib/Resque.pm]
...
TO_INST_PM = README.pod \
	lib/README.pod \
	lib/Resque.pm \
	lib/Resque/Client.pm \
	lib/Resque/Failure.pm \
	lib/Resque/Job.pm \
	lib/Resque/Queue.pm \
	lib/Resque/Worker.pm \
	lib/TestClass.pm

PM_TO_BLIB = lib/README.pod \
	blib/lib/README.pod \
	lib/Resque.pm \
	blib/lib/Resque.pm \
	README.pod \
	...
	lib/Resque/Client.pm \
	blib/lib/Resque/Client.pm \
	lib/Resque/Queue.pm \
	blib/lib/Resque/Queue.pm \
	lib/TestClass.pm \
	blib/lib/TestClass.pm \
	lib/Resque/Failure.pm \
	blib/lib/Resque/Failure.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/README.pod $(INST_MAN3DIR)/README.$(MAN3EXT) \
	  README.pod $(INST_MAN3DIR)/README.$(MAN3EXT) \
	  lib/Resque/Worker.pm $(INST_MAN3DIR)/Resque::Worker.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Devel::StackTrace" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="JSON::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Redis::" VERSION="1.904" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Sys::Hostname" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Time::HiRes" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.8" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/README.pod blib/lib/README.pod \
	  lib/Resque.pm blib/lib/Resque.pm \
	  README.pod $(INST_LIB)/README.pod \
	  lib/Resque/Worker.pm blib/lib/Resque/Worker.pm \
	  lib/Resque/Job.pm blib/lib/Resque/Job.pm \
	  lib/Resque/Client.pm blib/lib/Resque/Client.pm \
	  lib/Resque/Queue.pm blib/lib/Resque/Queue.pm \
	  lib/TestClass.pm blib/lib/TestClass.pm \
	  lib/Resque/Failure.pm blib/lib/Resque/Failure.pm 
